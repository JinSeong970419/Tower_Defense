...
public class TowerContainer : MonoBehaviour
{
    ...
    [SerializeField] GameObject fire_tower_2;
    [SerializeField] GameObject ice_tower_2;
    [SerializeField] GameObject nature_tower_2;

    [SerializeField] GameObject fire_tower_3;
    [SerializeField] GameObject ice_tower_3;
    [SerializeField] GameObject nature_tower_3;
    ...
    public Dictionary<string, GameObject> GetTowerContainer() { return towers; }
}
